                ...
                <div class="mega-container">
                    ...
                    <div id="languageSwitch" class="hidden">
                        <div class="popover-body">
                            <button type="button" class="icon icon-x close" data-dismiss="alert"></button>
                            ...
                            <div class="select-wrapper form-group">
                                <select class="form-control contrast" name="countries">
                                    <option value="USA" selected="selected">USA</option>
                                    <option value="AFG">Afghanistan</option>
                                </select>
                            </div>
                            <div class="select-wrapper form-group">
                                <select class="form-control contrast"><option value="en" selected="selected">English (United States)</option></select>
                            </div>
                            <button type="button" class="button primary" onclick="changeLanguage()">Change</button>
                        </div>
                    </div>
                    ...
                    <div id="notificationLanguageSwitch" class="hidden ">
                            <div class="popover-body">
                                <div class="page-location-notice">
                                    <button type="button" class="icon icon-x close" id="closeNotificationLanguageSwitch"></button>
                                  
                                    <h4 class="xx-smaller" id="notificationTitle"></h4>
                                    <p class="smaller" id="notificationMessage"></p>
                                    <button type="button" class="button primary" id="yesNotificationLanguageSwitch">Stay on this page</button>
                                    <button type="button" class="button empty primary" id="noNotificationLanguageSwitch"></button>
                                </div>
                            </div>
                        </div>
...
<form  id="searchForm" class="navbar-form navbar-right search-field " role="search">
    <div class="input-group add-on">

        <div class="group-selector ng-hide" >
            <div uib-dropdown="" class="input-group-btn dropdown" >
                <button uib-dropdown-toggle="" type="button" class="ng-binding dropdown-toggle" aria-haspopup="true" aria-expanded="false">
                    All
        ...
        <div class="input-group-btn">
            ...
            <button class="btn btn-default search-action" type="submit">
                <i class="fa fa-search"></i>
            </button>
        </div>
    ...
    <div class="row">
        <div class="container">
            <div class="menucontent col-md-12">
                ...
                <li>
                    <a href="/en-us/insights/?pagetype=Article">Articles/Topics</a>
                </li>
                <li>
                    <a href="/en-us/insights/?pagetype=Tool">Tools</a>
                </li>
                <li>
                    <a href="/en-us/insights/?pagetype=News">News</a>
                </li>
                <li>
                    <a href="/en-us/insights/?pagetype=Webcast">Webcasts</a>
                </li>
                <li>
                    <a href="/en-us/insights/?pagetype=Event">Events</a>
                </li>
                    </ul>
                    <ul class="same-height-target col-sm-3" >
                    <li class="menu-header"><a href="#" class="cursor-default">&nbsp;</a></li>
                <li>
                    <a href="/en-us/insights/?pagetype=BlogPost">Blog Posts</a>
                </li>
                <li>
                    <a href="/en-us/insights/?pagetype=Infographic">Infographics</a>
                </li>
                <li>
                    <a href="/en-us/insights/?pagetype=Video">Videos</a>
                </li>
                <li>
                    <a href="/en-us/insights/?pagetype=CaseStudy">Case Studies</a>
                </li>
                <li>
                    <a href="/en-us/insights/?pagetype=WhitePaper">White Papers</a>
                </li>
                    </ul>
                    <ul class="same-height-target col-sm-3" >
                    <li class="menu-header"><a href="#" class="cursor-default">TOPICS</a></li>
                <li>
                    <a href="/en-us/insights/topics/availability--uptime/">Availability &amp; Uptime</a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/cloud-computing/">Cloud Computing</a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/compliance-security/">Compliance &amp; Security  </a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/dcim-it-management/">DCIM &amp; IT Management</a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/edge-computing/">Edge Computing</a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/efficiency/">Efficiency</a>
                </li>
                    </ul>
                    <ul class="same-height-target col-sm-3">
                    <li class="menu-header"><a href="#" class="cursor-default">&nbsp;</a></li>
                <li>
                    <a href="/en-us/insights/topics/facility-optimization/">Facility Optimization </a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/internet-of-things/">Internet of Things (IoT)</a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/monitoring/">Monitoring</a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/thermal-management/">Thermal Management</a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/total-cost-of-ownership/">Total Cost of Ownership</a>
                </li>
                <li>
                    <a href="/en-us/insights/topics/unified-infrastructure/">Unified Infrastructure</a>
                </li>
                    </ul>
            </div>
        </div>
...
<div class="dropdown-menu same-height-component">
    <div class="row">
        ...
        <ul class="same-height-target col-sm-3" >
<li class="menu-header">
    <a href="/en-us/about/about-vertiv/" target="_parent" class="">
        OVERVIEW
    </a>
</li>

    <li>
                    <a href="/en-us/about/about-vertiv/vision-mission/" target="_parent">
                Vision and Mission
            </a>
    </li>
    <li>
                    <a href="/en-us/about/about-vertiv/executives/" target="_parent">
                Executives
            </a>
    </li>
    <li>
                    <a href="/en-us/about/about-vertiv/history/" target="_parent">
                History
            </a>
    </li>
    <li>
                    <a href="/en-us/about/about-vertiv/corporate-video/" target="_parent">
                Corporate Video
            </a>
    </li>
    <li>
                    <a href="/link/27467ea138db47d2a986bb610535ea2c.aspx" target="_parent">
                Fact Sheet
            </a>
    </li>
    <li>
                    <a href="/en-us/about/about-vertiv/connect-with-us/" target="_parent">
                Connect With Us
            </a>
    </li>
    <li>
                    <a href="/en-us/about/about-vertiv/vertiv-tweets/" target="_parent">
                Vertiv Tweets
            </a>
    </li>
<li class="menu-header">
    <a href="/en-us/about/contacts/" target="_parent" class="">
        CONTACTS
    </a>
</li>

    <li>
                    <a href="/en-us/about/contacts/sales/" target="_parent">
                Sales
            </a>
    </li>
    <li>
                    <a href="/en-us/about/contacts/corporate/" target="_parent">
                Corporate
            </a>
    </li>
    <li>
                    <a href="/en-us/about/contacts/support/" target="_parent">
                Support
            </a>
    </li>
        </ul>
            <ul class="same-height-target col-sm-3" >
<li class="menu-header">
    <a href="/en-us/about/newsroom/" target="_parent" class="">
        NEWSROOM
    </a>
</li>

    <li>
                    <a href="/en-us/about/newsroom/media-contacts/" target="_parent">
                Media Contacts
            </a>
    </li>
    <li>
                    <a href="/en-us/about/newsroom/corporate-news/" target="_parent">
                News Releases
            </a>
    </li>
    <li>
                    <a href="/en-us/about/newsroom/media-kits/" target="_parent">
                Media Kits 
            </a>
    </li>
    <li>
...
<li class="menu-header">
    ...
    <li>
                    <a href="/en-us/about/partners/find-a-partner/" target="_parent">
                Find a Partner
            </a>
    </li>
    <li>
                    <a href="/en-us/about/partners/partner-portal/" target="_parent">
                Partner Portal
            </a>
    </li>
    <li>
                    <a href="/en-us/about/partners/energynet-portal/" target="_parent">
            ...
            <ul class="same-height-target  col-sm-3" >
<li class="menu-header">
    <a href="/en-us/about/careers/" target="_parent" class="">
        CAREERS
    </a>
</li>

    <li>
                    <a href="/en-us/about/careers/search-careers/" target="_parent">
                Search Careers
            </a>
    </li>
    <li>
                    <a href="/en-us/about/careers/internship-co-op-and-mba-programs/" target="_parent">
                Internship, Co-op, and MBA Programs
            </a>
    </li>
    <li>
                    <a href="/en-us/about/careers/diversity--inclusion/" target="_parent">
                Diversity &amp; Inclusion
            </a>
    </li>
    <li>
                    <a href="/en-us/about/careers/military-vet/" target="_parent">
                Military &amp; Veterans
            </a>
    </li>
    <li>
                    <a href="/en-us/about/careers/learning-career-opportunities/" target="_parent">
