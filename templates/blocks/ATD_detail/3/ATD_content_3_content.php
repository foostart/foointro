                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-7 col-lg-6 product-hero-content ">
                                <span class="subtitle x-light">Uninterruptible Power Supplies (UPS)</span>
                            ...
                            <div class="col-sm-7 col-sm-offset-5">
                                <div class="row">
                                    <div class="list-tile col-sm-4">
                                        <span class="subtitle dark">BEST SUITED FOR</span>
                                        <ul>
            ...
            <div class="nho">
                ...
                <div class="list-tile-component">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <span class="subtitle dark note">This product is approved by the ETL (Energy Technology List)</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
