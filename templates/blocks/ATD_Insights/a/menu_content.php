                        ...
                        <div class="form-group">
                            <div class="select-wrapper">
                                <select class="form-control" name="mobileCountries">
                                    ...
                                    <option value="BLR">Belarus (�?‘�?µ�?»�?°Ñ€Ñƒï¿½?ÑŒ)</option>
                                    ...
                                    <option value="KAZ">Kazakhstan (Òš�?°�?·�?°Ò›ï¿½?Ñ‚�?°�?½)</option>
                                    <option value="KEN">Kenya</option>
                                    <option value="KIR">Kiribati</option>
                                    <option value="KOR">Korea (í•œêµ­)</option>
                                    <option value="XKX">Kosovo</option>
                                    <option value="KWT">Kuwait</option>
                                    <option value="KGZ">Kyrgyzstan (�?šÑ‹Ñ€�?³Ñ‹�?·ï¿½?Ñ‚�?°�?½)</option>
                                    <option value="LAO">Laos</option>
                                    <option value="LVA">Latvia (�?›�?°Ñ‚�?²�?¸ï¿½?)</option>
                                    <option value="LBN">Lebanon</option>
                                    <option value="LSO">Lesotho</option>
                                    <option value="LBR">Liberia</option>
                                    <option value="LBY">Libya</option>
                                    <option value="LIE">Liechtenstein</option>
                                    <option value="LTU">Lithuania (�?›�?¸Ñ‚�?²�?°)</option>
                                    ...
                                    <option value="RUS">Russian Federation (�? �?¾ï¿½?ï¿½?�?¸ï¿½?)</option>
                                    ...
                                    <option value="TJK">Tajikistan (�?¢�?¾Ò·�?¸�?º�?¸ï¿½?Ñ‚�?¾�?½)</option>
                                    ...
                                    <option value="TKM">Turkmenistan (�?¢Ò¯Ñ€�?º�?¼�?µ�?½�?¸ï¿½?Ñ‚�?°�?½)</option>
