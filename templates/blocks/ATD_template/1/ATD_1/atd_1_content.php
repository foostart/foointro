...
<div class="tab_mobile">
        ...
        <div class="header">
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="hiding-header" data-paxy-class="hidden,149,100000" data-paxy="height,243,149,px,0,149">
                    <div class="text-center">
                        <a href="/en-us/" target="_parent" class="navbar-brand-full">
                                ...
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        ...
                                        <ul class="same-height-target cor col-sm-3">
                                            ...
                                            <li><a href="#">ASCO&#174</a></li>
                                            <li><a href="#">Chloride&#174</a></li>
                                            <li><a href="#">Liebert&#174</a></li>
                                            <li><a href="#">NetSure&#174</a></li>
                                ...
                                <div class="form-group">
                                    <div class="select-wrapper">
                                        <select class="form-control" name="mobileCountries">
                                            ...
                                            <option value="AUT">Austria (Ã–sterreich)</option>
                                            <option value="AZE">Azerbaijan</option>
                                            <option value="BHS">Bahamas</option>
                                            <option value="BHR">Bahrain</option>
                                            <option value="BGD">Bangladesh</option>
                                            <option value="BRB">Barbados</option>
                                            <option value="BLR">Belarus (Ð‘ÐµÐ»Ð°Ñ€Ñƒï¿½?ÑŒ)</option>
                                            <option value="BEL">Belgium (Belgique/BelgiÃ«)</option>
                                            ...
                                            <option value="CAF">Central African Republic (RÃ©publique centrafricaine)</option>
                                            <option value="TCD">Chad (Tchad)</option>
                                            <option value="CHI">Channel Islands (ÃŽles de la Manche)</option>
                                            <option value="CHL">Chile</option>
                                            <option value="CHN">China (ä¸­å›½)</option>
                                            ...
                                            <option value="CYP">Cyprus (KÄ±brÄ±s)</option>
                                            <option value="CZE">Czech Republic</option>
                                            <option value="DNK">Denmark</option>
                                            <option value="DJI">Djibouti</option>
                                            <option value="DMA">Dominica</option>
                                            <option value="DOM">Dominican Republic (RepÃºblica Dominicana)</option>
                                            ...
                                            <option value="GAB">Gabon (RÃ©publique gabonaise)</option>
                                            ...
                                            <option value="GIN">Guinea (GuinÃ©e)</option>
                                            <option value="GNB">Guinea-Bissau</option>
                                            <option value="GUY">Guyana</option>
                                            <option value="HTI">Haiti</option>
                                            <option value="VAT">Holy See (Vatican City State)</option>
                                            <option value="HND">Honduras</option>
                                            <option value="HKG">Hong Kong (é¦™æ¸¯)</option>
                                            ...
                                            <option value="CIV">Ivory Coast (CÃ´te d'Ivoire)</option>
                                            <option value="JAM">Jamaica</option>
                                            <option value="JPN">Japan</option>
                                            <option value="JOR">Jordan</option>
                                            <option value="KAZ">Kazakhstan (ÒšÐ°Ð·Ð°Ò›ï¿½?Ñ‚Ð°Ð½)</option>
                                            <option value="KEN">Kenya</option>
                                            <option value="KIR">Kiribati</option>
                                            <option value="KOR">Korea (í•œêµ­)</option>
                                            <option value="XKX">Kosovo</option>
                                            <option value="KWT">Kuwait</option>
                                            <option value="KGZ">Kyrgyzstan (ÐšÑ‹Ñ€Ð³Ñ‹Ð·ï¿½?Ñ‚Ð°Ð½)</option>
                                            <option value="LAO">Laos</option>
                                            <option value="LVA">Latvia (Ð›Ð°Ñ‚Ð²Ð¸ï¿½?)</option>
                                            <option value="LBN">Lebanon</option>
                                            <option value="LSO">Lesotho</option>
                                            <option value="LBR">Liberia</option>
                                            <option value="LBY">Libya</option>
                                            <option value="LIE">Liechtenstein</option>
                                            <option value="LTU">Lithuania (Ð›Ð¸Ñ‚Ð²Ð°)</option>
                                            <option value="LUX">Luxembourg</option>
                                            <option value="MAC">Macau (æ¾³é–€)</option>
                                            ...
                                            <option value="MOZ">Mozambique (MoÃ§ambique)</option>
                                            ...
                                            <option value="RUS">Russian Federation (Ð Ð¾ï¿½?ï¿½?Ð¸ï¿½?)</option>
                                            <option value="RWA">Rwanda</option>
                                            <option value="WSM">Samoa</option>
                                            <option value="SMR">San Marino</option>
                                            <option value="STP">Sao Tome and Principe (SÃ£o TomÃ© e PrÃ­ncipe)</option>
                                            ...
                                            <option value="ESP">Spain (EspaÃ±a)</option>
                                            ...
                                            <option value="TWN">Taiwan (è‡ºï¿½?ï¿½)</option>
                                            <option value="TJK">Tajikistan (Ð¢Ð¾Ò·Ð¸ÐºÐ¸ï¿½?Ñ‚Ð¾Ð½)</option>
                                            ...
                                            <option value="TUR">Turkey (TÃ¼rkiye)</option>
                                            <option value="TKM">Turkmenistan (Ð¢Ò¯Ñ€ÐºÐ¼ÐµÐ½Ð¸ï¿½?Ñ‚Ð°Ð½)</option>
