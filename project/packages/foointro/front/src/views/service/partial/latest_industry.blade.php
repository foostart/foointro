<div class="banner_4">
    <div class="banner_5">
        <div class="row">
            <h3 class="text-center xx-light xx-thick">LATEST INDUSTRY TRENDS, TECHNOLOGIES AND SOLUTIONS</h3>
            <div class="col-md-6" style="background-color: #FFFFFF">
                <div class="top">
                    <div class="col-sm-6">
                        <img src="foointro/front/image/service/1.jpg" alt="" />
                    </div>
                    <div class="col-sm-6">
                        <div class="text1">
                ...
                <div class="bot">
                    <img src="foointro/front/image/service/2.jpg" alt="" />
                    <div class="text2">
            ...
            <div class="col-md-6" style="background-color: #FFFFFF">
                <div class="bot">
                    <img src="foointro/front/image/service/3.jpg" alt="" />
                    <div class="text3">
                ...
                <div class="top">
                    <div class="col-sm-6">
                        <img src="foointro/front/image/service/4.jpg" alt="" />
                    </div>
                    <div class="col-sm-6">
                        <div class="text4">
    ...
    <div class="text-center" style="    padding: 5.6rem 2rem 4.6rem;
        background: #4d4d4d;">
        <a href="#" type="button" class="button primary">See All Insights</a>
    </div>
</div>