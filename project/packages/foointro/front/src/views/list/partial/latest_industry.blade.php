    ...
    <div class="banner_5">
        <div class="row">
            ...
            <div class="col-md-6" style="background-color: #FFFFFF">
                <div class="top">
                    <div class="col-sm-6">
                        <img src="foointro/front/image/list/1.jpg" alt="" />
                    </div>
                    <div class="col-sm-6">
                        <div class="text1">
                ...
                <div class="bot">
                    <img src="foointro/front/image/list/2.jpg" alt="" />
                    <div class="text2">
            ...
            <div class="col-md-6" style="background-color: #FFFFFF">
                <div class="bot">
                    <img src="foointro/front/image/list/3.jpg" alt="" />
                    <div class="text3">
                ...
                <div class="top">
                    <div class="col-sm-6">
                        <img src="foointro/front/image/list/4.jpg" alt="" />
                    </div>
                    <div class="col-sm-6">
                        <div class="text4">
