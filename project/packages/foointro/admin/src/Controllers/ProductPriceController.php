...
use Route,
    Redirect;
use Foointro\Admin\Models\ProductPrices;
...
class ProductPriceController extends Controller {
    ...
    private $obj_product_price = NULL;
    private $obj_validator = NULL;

    public function __construct() {
        $this->obj_product_price = new ProductPrices();
    }
    ...
    public function index(Request $request) {
        ...
        $list_product = $this->obj_product_price->get_products($params);

        $this->data_view = array_merge($this->data_view, array(
            'products' => $list_product,
            'request' => $request
        ));
        // $root_product = $this->obj_product_price->root_product();
        // $all_product = $this->obj_product_price->pluckproduct();
    ...
    public function edit(Request $request) {
        ...
        if (!empty($product_id) && (is_int($product_id))) {
            $product = $this->obj_product_price->find($product_id);
            $root_product = $this->obj_product_price->get_root_product(2);
            $child_product = $this->obj_product_price->get_root_product($product->product_parent);
    ...
    public function get_data(Request $request){
        $key = $request->get('key');
        // var_dump($key);
        $root_product = $this->obj_product_price->get_root_product($key);
        // var_dump($root_product);
        ...
        if (!$this->obj_validator->validate($input)) {
            ...
            if (!empty($product_id) && is_int($product_id)) {
                ...
                if (!empty($product)) {
                    ...
                    $product = $this->obj_product_price->update_product($input);
                ...
                // var_dump($input);
                // die();
                $product = $this->obj_product_price->add_product($input);
